...
edit_button.click()
target_element = wait.until(CO.presence_of_element_located((By.ID, "question-submission-form-qn-2")))
...
time.sleep(10)
driver.save_screenshot("CFC_035_EV1.png")
question.clear()
question.send_keys("Ahora si esto si es una nueva respuesta para el Test")
...
driver.save_screenshot("CFC_035_EV2.png")
modal = wait.until(CO.visibility_of_element_located((By.CSS_SELECTOR, "ngb-modal-window[role='dialog']")))
